...
//    private By newsBy = By.linkText("新鲜事");
    ...
    private By homeLinkTabBy = By.xpath("//*[@id=\"nxSlidebar\"]/div[1]/div/ul/li[4]/a");
    private By myPhotosTabBy = By.xpath("//*[@id=\"nxSlidebar\"]/div[1]/div/ul/li[5]/a");
    ...
    public Po_main(WebDriver driver) throws Exception{
        ...
        driverWait.until(ExpectedConditions.presenceOfElementLocated(myPhotosTabBy));
    }
