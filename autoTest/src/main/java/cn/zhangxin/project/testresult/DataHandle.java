...
public class DataHandle {
     ...
     *return 秒,保留3位小数
     */
    public String calTestDuration(ITestContext context){
        long duration;
     ...
     *return 2.22%,保留2位小数
     */
    public String calPercentage(int numerator, int denominator)
    {
...
//        return collectionToString(Arrays.asList(methods));
//    }
    /**
     * 堆栈轨迹，暂不确定怎么做，放着先
     * @param throwable
...
//    }
    ...
    /*将object 转换为String*/
    private String objectToString(Object argument)
    {
        if (argument == null)
        {
            return "null";
    ...
    /*将集合转换为以逗号分隔的字符串*/
    private String collectionToString(Collection<String> strings)
    {
